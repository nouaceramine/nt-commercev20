...
**Latest:** p372 (2026-09-11) — فاتورة/إيصال الزبون للمطعم: GET /restaurant/kitchen-orders/{id}/receipt (ترويسة المتجر، عناصر بمؤشرات الدفع، خصم/صافي، تفصيل دفعات p366 بأرقام الفواتير، استرجاع الطلبات القديمة المدفوعة) + زر طباعة ومنطقة طباعة مخفية في حوار الطاولة (36/36 E2E). Chain: p341→p342→p343→p344→p345→p346→p347→p348→p349→p350→p351→p352→p353→p354→p355→p356→p357→p358→p359→p360→p361→p362→p363→p364→p365→p366→p367→p368→p369→p370→p371→p372.
