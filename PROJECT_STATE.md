...
**Latest:** p309 (2026-08-26) — وجبات Combo: معالج إنشاء (منتج حزمة + وصفة مكونات قابلة للبيع) يعيد استخدام محرك الوصفات؛ البيع يستهلك المكونات ويكلّف بالتكلفة الحقيقية تلقائيًا. Previous: p308. Chain: …→p307→p308→p309.
...
- **الخطة ب — واجهة متخصصة:** ~~شاشة مطبخ KDS~~ ✅ (p306، منشورة) + ~~إضافات/بدائل (modifiers)~~ ✅ (p308) + ~~وجبات Combo~~ ✅ (p309) + مخطط طاولات بصري + تقسيم الفاتورة
