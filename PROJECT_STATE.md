...
**Latest:** p319 (2026-08-26) — تجهيز مثال بيتزيريا كامل في NT-0025: 4 مكوّنات مخزونية + فاتورة شراء PUR-20260826-0001 + طبق بيتزا مارغريتا (غير مخزوني 800 دج) + وصفة (تكلفة حية 278 دج) + مجموعة إضافات بثلاثة خيارات مربوطة بالمخزون. Previous: p318. Chain: …→p317→p318→p319.
