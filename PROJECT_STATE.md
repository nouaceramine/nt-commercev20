...
**Latest:** p305 (2026-08-26) — تقرير Food Cost + الهالك (خطة المطاعم أ 3/3 — **الخطة أ مكتملة**): مسارات waste/food-cost-report + تبويب «تكلفة الطعام» في صفحة الإنتاج (ملخص + ربحية الأطباق + الاستهلاك النظري + سجل الهالك). Previous: p304. Chain: …→p303→p304→p305.
