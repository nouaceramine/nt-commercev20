...
**Latest:** p327 (2026-08-27) — النسخ الخارجي مفعّل: rclone→B2 بمفتاح محدود النطاق، أول نسخة مشفرة مرفوعة واختبار فك تشفير ناجح — يوميًا 04:30 تلقائيًا. Previous: p326. Chain: …→p325→p326→p327.
