...
**Latest:** p401 (2026-09-21) — تصدير الإقفال اليومي Z كملف CSV (BOM لـ Excel) مع زر في بطاقة Z (E2E 27/27). Chain: p392→p393→p394→p395→p396→p397→p398→p399→p400→p401
