...
**Latest:** p363 (2026-09-08) — أداء المطبخ: ختم انتقالات الحالة + /restaurant/kitchen-stats (انتظار/تحضير/كلي، متأخر ≥15د، أبطأ الأطباق، توزيع بالساعة بتوقيت الجزائر) + شريط شارات في شاشة المطبخ (22/22). Previous: p362 (توحيد الدفاتر). Chain: …→p350→p351→p352→p354→p355→p356→p357→p358→p359→p360→p361→p362→p363.
