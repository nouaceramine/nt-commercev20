...
**Latest:** p364 (2026-09-08) — من التوقع إلى الشراء بنقرة: /production/demand-forecast/create-purchase يحوّل اقتراحات p313 إلى مسودة شراء draft حقيقية (رقم PUR- ذرّي، لا تلامس المخزون حتى التأكيد فيسري p171/p359) + زر ومنتقي مورد في تبويب التوقع (22/22). Previous: p363 (أداء المطبخ). Chain: …→p350→p351→p352→p354→p355→p356→p357→p358→p359→p360→p361→p362→p363→p364.
