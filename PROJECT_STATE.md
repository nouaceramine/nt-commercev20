...
**Latest:** p281 (2026-08-24) — Screen2ipcam DVR phase 1: /screen-recording setup guide + tenant device registry (backend routes/screen_recording_routes.py). Chain: p276→p277→p278→p279→p280→p281.
