...
**Latest:** p350 (2026-08-30) — المرآة الحية: وكيل Windows (agents/rlynx/nt_sync_agent.py، pyodbc، علامات مائية + هاش الأصناف، --baseline) + استقبال آمن برموز ntsync (هاش SHA-256، إبطال فوري، حد 3 وكلاء) + live_sync.py بمنطق p349 نفسه وFIFO تزايدي للسدادات + بطاقة واجهة كاملة (رمز/تحميل وكيل+إعداد/حالة). idempotent مُثبت؛ E2E 19/19. Previous: p349 (محوّل rlynx كمنتج). Chain: …→p339→p340…→p347→p348→p349.
