...
## 6) الخطوة التالية — p205: ثغرات التأجير المجاورة (اكتُشفت في p202)
...
4. بعدها: p206 التقارير الضريبية من سطور اليومية (p201 في الخارطة القديمة)، ثم واجهة القيد اليدوي، ثم قفل السنة.
...
- النسخ الاحتياطية: /opt/ntcommerce/backups/p182..p204
