...
**Latest:** p322 (2026-08-27) — إدارة شاشات التلفاز مركزيًا: /tv بإقران بكود 6 أرقام (يبقى بعد إطفاء الجهاز) + صفحة /screens للتحكم (تسمية/محتوى/فك ارتباط/حالة اتصال) — مثبت E2E بالكامل. Previous: p321. Chain: …→p320→p321→p322.
