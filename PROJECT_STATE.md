...
**Latest:** p310 (2026-08-26) — خريطة طاولات بصرية + تقسيم فاتورة POS + إصلاح خلل تكرار كود الفاتورة عند التقسيم (p310b). **الخطة ب مكتملة**. Previous: p309. Chain: …→p308→p309→p310.
