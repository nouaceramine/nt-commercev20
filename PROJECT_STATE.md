...
**Latest:** p320 (2026-08-27) — شاشة تلفاز المنتجات بالمخزون الحي /tv/menu/:tenantId (توفر من الوصفات/المخزون، «نفذت الكمية» تلقائيًا، تحديث كل 10 ث) + قسم شاشات التلفاز في دليل المطعم. Previous: p319. Chain: …→p318→p319→p320.
