...
**Latest:** p356 (2026-09-03) — ولاء الكاشير: كسب تلقائي للنقاط في POS ودفع طلبات المطعم (services/pos_loyalty.py، بوابة إعدادات، idempotent، زبون بالهاتف) + واجهتا POS — أُغلقت حلقة الكسب المكسورة منذ p181 (17/17). Previous: p355 (مطابقة النظامين). Chain: …→p348→p349→p350→p351→p352→p354→p355→p356.
