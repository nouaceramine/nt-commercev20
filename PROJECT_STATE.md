...
**Latest:** p355 (2026-08-31) — تقرير المطابقة اليومي بين النظامين: الوكيل v2.2 يرسل خلاصة يومية من قاعدة القديم، الخادم يطابقها بالمخزَّن (GET /api/migration/live/reconciliation) ويقترح الفصال بعد 30 يوماً متطابقاً + بطاقة واجهة (23/23). Previous: p354 (تدريب الاستعادة الخارجية). Chain: …→p339→p340…→p348→p349→p350→p351→p352→p354→p355.
