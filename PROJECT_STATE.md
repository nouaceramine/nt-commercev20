...
**Latest:** p361 (2026-09-03) — اقتراحات الكاشير الذكية: /sales/suggestions بتجميع co-occurrence (نافذة 2000 بيع، المرتجعات والموقوفة مستبعدة) + شريط «معها غالباً» في POS يضيف بنقرة عبر addProductSmart (21/21). Previous: p360 (الكشك الذاتي). Chain: …→p350→p351→p352→p354→p355→p356→p357→p358→p359→p360→p361.
