...
**Latest:** p328 (2026-08-27) — أتمتة DNS عبر Cloudflare: رمز مشفر + خدمة + نهايات saas + نطاق فرعي تلقائي لكل متجر (<slug>.nt-commerce.net يفتح المتجر مباشرة، مثبت على bida/rahimplatre) — SSL للسحاب يتطلب Enterprise. Previous: p327. Chain: …→p326→p327→p328.
