...
**Latest:** p352 (2026-08-30) — حزمة الوكيل لويندوز: nt_sync_agent_kit.zip من /api/migration/live/agent/kit (وكيل v2.1 frozen-aware + build_exe.bat + install_task.bat + دليل عربي) — المشترك يبني exe بنقرة ويشغّله تلقائياً مع ويندوز. Previous: p351 (تعميم SQL Server). Chain: …→p339→p340…→p347→p348→p349.
