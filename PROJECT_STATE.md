...
**Latest:** p339 (2026-08-28) — حزمة طلبات المالك العشر مكتملة: فلترة المشتركين بالنشاط (p330)، تنظيف تسجيلات موجهات ميتة (p331)، تحقق DVR للكل (p332)، تقسيم/تحديد منتجات شاشات TV (p333)، روابط اجتماعية + مشاركة طاولة في QR (p334)، الجيران B2B بأسعار خاصة ودين (p335)، دفع مسبق/لاحق + فاتورة موحدة (p336)، خصومات/كوبونات + طلبيات مجدولة بتذكير (p337)، شاشة مطبخ بمصدر الطلب وطبع تلقائي (p338)، POS مطاعم بوضعَي طاولات/سريع والأكثر مبيعًا أولًا (p339). بناء موحد main.69b94a0c.js + نشر 20260827_211855 + Playwright 18/18 + residue=0. Previous: p329. Chain: …→p328→p329→p330…→p339.
