...
**Latest:** p318 (2026-08-26) — إصلاح المسح الصامت لميزات الأنشطة (restaurant/production/rental) من حوار ميزات المشتركين + إعادة تفعيل ملف المطعم على NT-0025 والتحقق بالمتصفح (قسم المطعم والإنتاج ظاهران). Previous: p317. Chain: …→p316→p317→p318.
