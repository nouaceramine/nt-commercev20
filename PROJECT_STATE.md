...
**Latest:** p307 (2026-08-26) — ملف نشاط المطعم يفعّل production تلقائيًا (وصفات/تكلفة طعام/هالك) + تطبيقه رسميًا على NT-0025 (audit: 27/27 ok). Previous: p306. Chain: …→p305→p306→p307.
