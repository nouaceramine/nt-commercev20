...
**Latest:** p321 (2026-08-27) — صور الأطباق على شاشة التلفاز (معرض 5 صور/منتج) + وضع شرائح إعلاني ?mode=slider يدور كل 8 ث + طبق تجريبي ثانٍ «بيتزا الدجاج» بصورته ووصفته في NT-0025. Previous: p320. Chain: …→p319→p320→p321.
