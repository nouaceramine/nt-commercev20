...
**Latest:** p376 (2026-09-12) — جولة انحدار شاملة: إعادة تشغيل أجنحة E2E العشرة p365–p374 على النشرة الحالية = 264/264 بلا انحدارات؛ النظام سليم (health/Redis/سجلات نظيفة/بقايا اختبارات صفر). Chain: p341→p342→p343→p344→p345→p346→p347→p348→p349→p350→p351→p352→p353→p354→p355→p356→p357→p358→p359→p360→p361→p362→p363→p364→p365→p366→p367→p368→p369→p370→p371→p372→p373→p374→p375→p376.
