...
**Latest:** p289 (2026-08-24) — سير عمل إرسال الطلبات: معالجة يدوي/تلقائي لكل طلب (ناقلون مربوطون فقط، بوليصة + طباعة)، تذكير SMS/WhatsApp برصيد المحفظة، عمود حالة الناقل على الطلبات (⚡/✋ + مسجَّل/غير مسجَّل + تتبع). Previous: p288 (توحيد الطلبات + الهيكلة السباعية). Chain: …→p286→p287→p288→p289.
