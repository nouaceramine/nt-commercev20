...
**Latest:** p295 (2026-08-24) — محرك عمولات المنصة يغطي الآن IPTV/الخدمات الرقمية (هامش على سعر الجملة عند بيع الاشتراك من المحفظة) + الذكاء الاصطناعي (تلقائياً مع الفوترة الشهرية) + SMS (فرق سعر البيع عن كلفة المنصة عند منح الرصيدات)، مع إعدادات لكل خدمة في تبويب عمولات المنصة. Previous: p294 (عمال المتجر). Chain: …→p292→p293→p294→p295.
