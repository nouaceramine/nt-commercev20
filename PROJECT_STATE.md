...
**Latest:** p359 (2026-09-03) — تنبيه انحراف كلفة الوصفات: خدمة cost_drift (عتبة 5%) معلَّقة على مزامنة purchase_price في مسارَي الشراء (مباشر + تأكيد مخزون) ← إشعار جرس عربي بالكلفة والهامش الجديد + cost_drift_log (30/30). Previous: p358 (هندسة القائمة). Chain: …→p350→p351→p352→p354→p355→p356→p357→p358→p359.
