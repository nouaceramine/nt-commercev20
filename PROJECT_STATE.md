...
**Latest:** p362 (2026-09-03) — توحيد دفاتر المطعم: الدفع المباشر cash/card لطلبات المطبخ يُنشئ فاتورة بيع ذرّية (مخزون+صندوق+زبون) ويربطها بالطلب، الآجل بلا قيد، بلا كسب ولاء مزدوج، idempotent (27/27). Previous: p361 (اقتراحات الكاشير). Chain: …→p350→p351→p352→p354→p355→p356→p357→p358→p359→p360→p361→p362.
