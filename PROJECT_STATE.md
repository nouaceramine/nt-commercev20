...
**Latest:** p386 (2026-09-13) — تصعيد صوتي للطلبات المتأخرة ≥15د في شاشة المطبخ (نغمة ثلاثية + منبثق، مرة واحدة لكل طلب). Chain: p367→p368→p369→p370→p371→p372→p373→p374→p375→p376→p377→p378→p379→p380→p381→p382→p383→p384→p385→p386
