...
**Latest:** p315 (2026-08-26) — إشعار واتساب عند جاهزية الطلب: customer_phone مطبَّع (QR + كاشير) + إرسال عند served مع ready_notified (لا يفشل عند غياب التهيئة). Previous: p314. Chain: …→p313→p314→p315.
...
- **الخطة ج — منظومة متكاملة:** QR على الطاولة + تطبيق نادل + شاشة انتظار + تكامل توصيل (Yassir) + ~~تنبؤ AI بمبيعات الأطباق ← قائمة مشتريات تلقائية~~ ✅ (p313) + ~~إشعار WhatsApp عند الجاهزية~~ ✅ (p315)
