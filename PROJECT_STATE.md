...
**Latest:** p304 (2026-08-26) — التكلفة الحية للوصفات (خطة المطاعم أ 2/3): GET /production/recipes يحسب live_unit_cost من أسعار الشراء الحالية + هامش الربح وFood Cost% لكل طبق في الواجهة؛ ثبت اختبارياً أن التكلفة تتبع تغيّر سعر الشراء فوراً. Previous: p303. Chain: …→p302→p303→p304.
...
- **الخطة أ — تصحيح الربحية:** ~~p303 ربط البيع بالوصفة~~ ✅ ← ~~p304 تكلفة حية تتبع الشراء فوراً + هامش ربح الطبق في الواجهة~~ ✅ ← p305 تقرير Food Cost % + ربحية الأطباق + الهالك
