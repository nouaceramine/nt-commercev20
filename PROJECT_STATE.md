...
**Latest:** p282 (2026-08-24) — Screen recording phase 2: live WebRTC preview via local MediaMTX (WHEP embedded player + new-tab fallback, guide section, E2E-proven with live test stream). Chain: p276→p277→p278→p279→p280→p281→p282.
