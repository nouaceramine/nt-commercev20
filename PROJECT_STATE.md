...
**Latest:** p292 (2026-08-24) — توحيد المفاتيح المبعثرة تحت مركز التكاملات (شحن/WooCommerce/SendGrid ← ملاحظات توجيه + مرآة sendgrid للمخزن القديم). Previous: p291 (غلق الحصة: تحويل تلقائي للمبلغ الفعلي إلى الخزنة بقيدي يومية + idempotency)، p290 (ربحية المنتج). Chain: …→p289→p290→p291→p292.
