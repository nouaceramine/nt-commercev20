...
**Latest:** p354 (2026-08-30) — تدريب الاستعادة الخارجية الشهري: scripts/offsite_restore_test.sh ينزّل أحدث حزمة مشفرة من B2 ويفكّ تشفيرها ويستعيدها فعلياً ويتحقق (أول تدريب ناجح، ok:true) — أُغلقت آخر حلقة في سلسلة النسخ الاحتياطي. Previous: p352 (حزمة وكيل ويندوز). Chain: …→p339→p340…→p347→p348→p349→p350→p351→p352→p354.
