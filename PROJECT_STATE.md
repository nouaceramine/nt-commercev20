...
**Latest:** p346 (2026-08-28) — حوكمة الوحدات الكاملة: سجل مركزي 44 وحدة بتغطية 100% لمسارات API (p340)؛ إنفاذ خادمي فعلي للبوابات بـmiddleware + كاش Redis وحوار ميزات ديناميكي 24 بوابة + bulk (p341)؛ توحيد whatsapp/email/suppliers/debts بأسماء بديلة (p342)؛ 44 روبوتاً حياً: probe→لوغ وحدة→system_errors→AutoHeal→إشعار مالك، مع تعافٍ تلقائي مثبت (p343)؛ إشعارات بريد+تليغرام للمالك (p344، ينتظر رمز بوت التليغرام من المالك)؛ شجرة سوبر أدمن←وكلاء←مشتركين بتبديل مفوَّض (p345)؛ اللوحة الأم للوحدات مع فحص فوري (p346). بناء main.520d28dc.js + نشر 20260828_014450 + Playwright 17/17. Previous: p339. Chain: …→p329→p330…→p339→p340…→p346.
