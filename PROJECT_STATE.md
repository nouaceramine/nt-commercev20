...
**Latest:** p406 (2026-09-25) — تصدير تقرير الحجوزات CSV (BOM لـ Excel) مع زر في بطاقة الحجوزات (E2E 27/27). Chain: p397→p398→p399→p400→p401→p402→p403→p404→p405→p406
