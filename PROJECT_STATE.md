...
**Latest:** p371 (2026-09-10) — تقرير إقفال اليوم (Z) للمطعم: GET /restaurant/z-report بتوقيت الجزائر (طلبات/ملغاة/خصومات/متوسط، تحصيل مفصَّل كاش/بطاقة/آجل يستثني الآجل من الإيراد، أعلى الأطباق، توزيع ساعي) + بطاقة الإقفال في خريطة الطاولات. Chain: p341→p342→p343→p344→p345→p346→p347→p348→p349→p350→p351→p352→p353→p354→p355→p356→p357→p358→p359→p360→p361→p362→p363→p364→p365→p366→p367→p368→p369→p370→p371.
