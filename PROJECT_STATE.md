...
**Latest:** p316 (2026-08-26) — طلبات التوصيل للمطاعم: طلب توصيل يولّد طلب مطبخ مرافقًا (KDS) + سائق/حالات/إلغاء متسلسل + تحصيل بفاتورة POS + ملخص — **الخطة ج مكتملة، ومسار المطاعم (أ+ب+ج) مكتمل بالكامل**. Previous: p315. Chain: …→p314→p315→p316.
