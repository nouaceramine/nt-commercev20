...
**Latest:** p326 (2026-08-27) — البريد مفعّل عبر Resend (مفتاح مشفر + sender noreply@nt-commerce.net + نطاق موثق) — بريد تجريبي delivered مثبت عبر Resend API. Previous: p325. Chain: …→p324→p325→p326.
