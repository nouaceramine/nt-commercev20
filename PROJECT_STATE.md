...
**Latest:** p283 (2026-08-24) — MP00001×2 test residue removed from real tenant (backed up first) + unique partial index on sales.code across all 27 tenant DBs. Chain: p276→p277→p278→p279→p280→p281→p282→p283.
