...
**Latest:** p300 (2026-08-25) — حذف الكود الميت: loyalty_members/integrations/integration_configs من 29 قاعدة + صفحتا TenantDashboardPage/AdvancedDashboard. أُبقيت sms_settings (يقرأها debt_robot). Previous: p299. Chain: …→p298→p299→p300.
