...
**Latest:** p366 (2026-09-08) — تقسيم فاتورة طلب المطعم: item_indexes في نقطة الدفع، فاتورة بيع حقيقية لكل دفعة، توزيع تناسبي للخصم مع تسوية دقيقة في الدفعة الأخيرة، حالة «مدفوع جزئياً» في خريطة الطاولات وشاشة المطبخ. Chain: p341→p342→p343→p344→p345→p346→p347→p348→p349→p350→p351→p352→p353→p354→p355→p356→p357→p358→p359→p360→p361→p362→p363→p364→p365→p366.
