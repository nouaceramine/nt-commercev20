...
**Latest:** p296 (2026-08-25) — إعدادات مفتاح AI للمنصة من لوحة السوبر أدمن (تبويب فوترة الذكاء): مفتاح/نقطة نهاية/نموذج محفوظة مشفّرة في DB وتغلب على env مع زر اختبار اتصال حي. Previous: p295 (عمولات IPTV/AI/SMS). Chain: …→p293→p294→p295→p296.
