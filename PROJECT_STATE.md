...
**Latest:** p358 (2026-09-03) — هندسة القائمة: /production/menu-engineering بتصنيف Kasavana–Smith (نجمة/حصان/لغز/كلب + توصية لكل طبق) + تبويب خامس في صفحة الإنتاج (19/19). Previous: p357 (إعادة التنشيط). Chain: …→p350→p351→p352→p354→p355→p356→p357→p358.
