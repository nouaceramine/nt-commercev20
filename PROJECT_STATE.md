...
**Latest:** p360 (2026-09-03) — الكشك الذاتي داخل المحل: /public/kiosk/{tenant} (قائمة+طلب بلا حساب، تفعيل من الإعدادات، خنق 10ث، تسعير من DB) ← طلب مطبخ source=kiosk بلا طاولة + صفحة KioskPage برقم طلب كبير وعدّ تنازلي (26/26). Previous: p359 (انحراف الكلفة). Chain: …→p350→p351→p352→p354→p355→p356→p357→p358→p359→p360.
