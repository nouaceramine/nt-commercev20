...
**Latest:** p302 (2026-08-25) — جاهزية النسخ السحابي: الحزمة المشفرة تضم mongo+env+compose (استرجاع كامل من نسخة واحدة) + دليل تفعيل المالك docs/OFFSITE_BACKUP_ACTIVATION.md؛ بقي فقط حساب B2. Previous: p301. Chain: …→p300→p301→p302.
