...
**Latest:** p351 (2026-08-30) — تعميم الترحيل: الوكيل v2 ثنائي المحرك (access/mssql بملف تعريف تعيين JSON) + أمر --dump ينتج حزمة قانونية bundle.zip، والمعالج يقبلها مباشرة (فحص بنية + zip-slip guard، نفس خط الاستيراد) — PC Compta/Sage/Ciel عبر SQL Server أصبحوا مدعومين بنيوياً (التحقق الميداني عند أول زبون). E2E حزمة حقيقية 20/20. Previous: p350 (المرآة الحية). Chain: …→p339→p340…→p347→p348→p349.
