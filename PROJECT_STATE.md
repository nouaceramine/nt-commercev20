...
**Latest:** p400 (2026-09-21) — تفعيل الطلبيات المجدولة يبث kitchen_order.created: KDS يُنبّه ويطبع تلقائيًا (E2E 18/18). Chain: p391→p392→p393→p394→p395→p396→p397→p398→p399→p400
