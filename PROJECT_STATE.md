...
**Latest:** p380 (2026-09-13) — تقرير فترة مخصصة للمطعم: نواة _zreport_agg مشتركة + GET /restaurant/period-report(.pdf)?date_from=&date_to= (افتراضي 7 أيام، سقف 92، توقيت الجزائر، تطابق مُثبت مع z-report لليوم الواحد) + بطاقة بمنتقيي تاريخ وزر PDF (24/24 E2E). Chain: p341→p342→p343→p344→p345→p346→p347→p348→p349→p350→p351→p352→p353→p354→p355→p356→p357→p358→p359→p360→p361→p362→p363→p364→p365→p366→p367→p368→p369→p370→p371→p372→p373→p374→p375→p376→p377→p378→p379→p380.
