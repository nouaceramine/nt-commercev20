...
**Latest:** p308 (2026-08-26) — إضافات/بدائل الأطباق: مجموعات خيارات لكل طبق (فرق سعر + خصم مخزون مكوّن مرتبط + استعادة مع الإرجاع) + حوار اختيار في POS + محرر في صفحة الإنتاج. Previous: p307. Chain: …→p306→p307→p308.
...
- **الخطة ب — واجهة متخصصة:** ~~شاشة مطبخ KDS~~ ✅ (p306، منشورة) + ~~إضافات/بدائل (modifiers)~~ ✅ (p308) + وجبات Combo + مخطط طاولات بصري + تقسيم الفاتورة
