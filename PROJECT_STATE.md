...
> آخر تحديث: 2026-08-21 بعد إتمام p212 — توحيد تقارير SmartReporterAgent (profit-loss/balance-sheet/cash-flow كلها من سطور اليومية الآن، والوكيل موسوم LEGACY). **المساران 1 و3 مكتملان؛ المتبقي: مسار 2 (يحتاج المالك) ومسار 4 (مؤجل).**
...
- p221: محرك عمولة تلقائي — قواعد لكل مستأجر على sale.completed، سجل + تقرير + دفع من الصندوق، قيود 658/421، إلغاء عند الإرجاع، صفحة /commissions
