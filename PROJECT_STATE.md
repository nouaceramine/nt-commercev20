...
**Latest:** p301 (2026-08-25) — دمج ياليدين: المسارات القديمة تقرأ/تكتب ecom_integrations (نفس مخزن المركز، مشفّر)؛ yalidine_settings أُحيلت للتقاعد. Previous: p300. Chain: …→p299→p300→p301.
