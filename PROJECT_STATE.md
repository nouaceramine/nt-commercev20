...
**Latest:** p297 (2026-08-25) — كبح تراكم auto_reports: upsert يومي بمفتاح طبيعي + فهارس فريدة + احتفاظ 90ي + تنظيف 11689 سطراً متراكماً (11497 tenant + 452→56 main). Previous: p296 (مفتاح AI من لوحة السوبر). Chain: …→p294→p295→p296→p297.
