...
**Latest:** p347 (2026-08-28) — تسمية قواعد بيانات المشتركين حسب النشاط: صيغة nt_<code>_<seq> بـ23 رمز نشاط منسّقاً (rs/rt/ws/ph...)؛ core/db_naming.py حلّال مركزي (كاش محلي ← Redis دائم ← fallback قديم) يعمل عبر 4 عمال uvicorn؛ ترحيل فعلي 28/28 قاعدة بـrenameCollection مع تحقق العدّ (NT-0004 آخراً بموافقة المالك — 36708 مبيعات/7415 منتجاً سليمة)؛ صفر قواعد tenant_* قديمة؛ 3 مسارات إنشاء تسمّي تلقائياً؛ E2E إنشاء←دخول unified-login 200←حذف (residue=0)؛ p341/p342 بلا انحدار. Previous: p346. Chain: …→p339→p340…→p346→p347.
