...
**Latest:** p285 (2026-08-24) — dashboard crash fixed: p273 Promise.all destructuring misalignment realigned + render hardening. Previous: p284 (instant shipping webhooks). — instant shipping webhooks: public per-token receiver + per-courier normalisers (Yalidine/Guepex/ZR/Maystro/Ecotrack), UI dialog with copy/rotate; polling remains for the rest. Chain: …→p282→p283→p284.
