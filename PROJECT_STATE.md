...
**Latest:** p357 (2026-09-03) — روبوت إعادة تنشيط الغائبين: كشف آخر نشاط (بيع/ولاء) + SMS يومي بتبريد مضاد للإزعاج + تبويب «التنشيط» في صفحة الولاء + /loyalty/reactivation/* (15/15). Previous: p356 (ولاء الكاشير). Chain: …→p349→p350→p351→p352→p354→p355→p356→p357.
