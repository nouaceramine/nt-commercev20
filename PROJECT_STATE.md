...
**Latest:** p325 (2026-08-27) — رمز QR دائم مطبوع للطاولة (/r/tid/tbl بلا رمز) + جلسة طلب مؤقتة عند كل مسح عبر /restaurant/public/table-session؛ الرابط المؤقت يموت بعد الدفع/التحرير ويُولَّد جديد — مثبت E2E. Previous: p324. Chain: …→p323→p324→p325.
