...
**Latest:** p317 (2026-08-26) — فحص انحدار شامل (دورة بيع بوصفة+إضافة: خصم/تكلفة/قيد/إرجاع كلها سليمة) + إصلاح انضمام تكلفة الإضافات إلى COGS + دليل تشغيل المطعم docs/RESTAURANT_GUIDE.md + تنظيف مخلفات TEST-P290 القديمة. Previous: p316. Chain: …→p315→p316→p317.
