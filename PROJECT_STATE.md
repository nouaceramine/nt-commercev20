...
**Latest:** p288 (2026-08-24) — توحيد الطلبات في /ecom-hub + هيكلة سباعية لتبويبات مركز التجارة (+مركز التكاملات) + إزالة حقول المفاتيح المبعثرة (متجر/قنوات/شحن/واتساب/بريد) مع مرايا تخزين (whatsapp_integration_settings/store_settings/email_settings) وتكامل Resend جديد (19). Previous: p287 (integrations hub). Chain: …→p285→p286→p287→p288.
