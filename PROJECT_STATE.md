...
**Latest:** p306 (2026-08-26) — شاشة مطبخ حية KDS (خطة المطاعم ب 1/3): أحداث kitchen_order.created/updated عبر outbox+SSE + صفحة /kitchen بثلاثة أعمدة حالة مع مؤقتات وأزرار لمسية + قسم «المطعم» في القائمة. Previous: p305. Chain: …→p304→p305→p306.
...
- **الخطة ب — واجهة متخصصة:** ~~شاشة مطبخ KDS~~ ✅ (p306، منشورة) + إضافات/بدائل (modifiers) + وجبات Combo + مخطط طاولات بصري + تقسيم الفاتورة
