...
**Latest:** p290 (2026-08-24) — ربحية كل منتج كاملة: أعمدة مُسلَّم/مُرجَع/تغليف، خسارة الإرجاع الكاملة (شحن+رسم الناقل+تغليف)، نسبة إعلانية مباشرة عبر product_id في المصروف (+ قائمة منتج في تبويب الإعلانات)، بطاقتا الرابح 🏆/الخاسر 📉، وحوار «سجل المنتج» بكل الطلبات والتكاليف. Previous: p289 (سير عمل إرسال الطلبات). Chain: …→p287→p288→p289→p290.
