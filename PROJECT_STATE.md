...
**Latest:** p365 (2026-09-08) — علامات الحساسية والنظام الغذائي للأطباق: dietary_tags على المنتج مع GET/PUT /restaurant/products/{id}/dietary، وعرض الوسوم في QR والكشك وقائمة الطاولة + إدارتها من صفحة الإنتاج. Chain: p341→p342→p343→p344→p345→p346→p347→p348→p349→p350→p351→p352→p353→p354→p355→p356→p357→p358→p359→p360→p361→p362→p363→p364→p365.
