...
**Latest:** p379 (2026-09-13) — تقرير الإقفال Z كملف PDF: GET /restaurant/z-report.pdf?date= عبر مساعد _zreport_payload المشترك مع p371 (A4، Noto Naskh مضمَّن، خلاصات + طرق التحصيل + أعلى الأطباق + توزيع ساعي) + زر تنزيل في بطاقة Z-report (18/18 E2E). Chain: p341→p342→p343→p344→p345→p346→p347→p348→p349→p350→p351→p352→p353→p354→p355→p356→p357→p358→p359→p360→p361→p362→p363→p364→p365→p366→p367→p368→p369→p370→p371→p372→p373→p374→p375→p376→p377→p378→p379.
