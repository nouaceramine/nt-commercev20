...
**Latest:** p284 (2026-08-24) — instant shipping webhooks: public per-token receiver + per-courier normalisers (Yalidine/Guepex/ZR/Maystro/Ecotrack), UI dialog with copy/rotate; polling remains for the rest. Chain: …→p282→p283→p284.
