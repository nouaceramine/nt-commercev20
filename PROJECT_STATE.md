...
**Latest:** p314 (2026-08-26) — شاشة العميل: لوحة أرقام طلبات عمومية /board/:tenantId (تلفاز المحل، تحديث 10 ث، أكواد بلا بيانات حساسة). Previous: p313. Chain: …→p312→p313→p314.
