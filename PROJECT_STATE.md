...
**Latest:** p329 (2026-08-28) — تعميم شاشات العرض (TV) على كل الأنشطة: نظام واحد لكل المشتركين (الإعدادات ← شاشات العرض، إقران عبر /tv برمز 6 أرقام)؛ كتالوج المنتجات/شرائح إعلانية لكل نشاط + قائمة/طلبات للمطاعم؛ نهاية catalog-board عامة بتوفر حي من المخزون. Previous: p328. Chain: …→p327→p328→p329.
