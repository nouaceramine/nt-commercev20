...
**Latest:** p311 (2026-08-26) — طلب QR من الطاولة: صفحة عمومية /r/:tenant/:table + مسارات public بنارية التحقق (أسعار من DB، خانع MongoDB) + تحميل طلب الطاولة لسلة POS + رمز QR في خريطة الطاولات. Previous: p310. Chain: …→p309→p310→p311.
