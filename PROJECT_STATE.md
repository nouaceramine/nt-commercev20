...
**Latest:** p287 (2026-08-24) — مركز التكاملات الموحّد /integrations: سجل 18 تكاملاً (شحن/تواصل/مراسلة/متاجر/مطورين)، ربط+فحص حقيقي+تفعيل تلقائي، مفاتيح مشفرة مقنّعة، ويب هوكات مدمجة. Previous: p286 (spare-parts families). Chain: …→p284→p285→p286→p287.
