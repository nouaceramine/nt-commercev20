...
export default function DashboardPage() {
  ...
  const statsCards = [
    ...
    { title: language === 'ar' ? 'رأس المال' : 'Capital', value: `${stats.total_cash?.toFixed(2) || 0} ${t.currency}`, icon: Banknote, color: 'text-blue-600', bgColor: 'bg-blue-100', link: '/cash', testId: 'capital-card' },
